package com.shebangs.supplier.ui.my;
...
public class MyViewModel extends ViewModel {
    ...
    public MyViewModel() {
        ...
        content.add(new ModuleNavigation(false, SupplierApp.getInstance().getString(R.string.nav_order_account), R.drawable.ic_account, null));
        content.add(new ModuleNavigation(false, SupplierApp.getInstance().getString(R.string.nav_order_recode), R.drawable.ic_recode, null));
    }
