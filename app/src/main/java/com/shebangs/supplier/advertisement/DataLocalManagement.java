package com.shebangs.supplier.advertisement;
        ...
        Runnable runnable = new Runnable() {
            ...
            public void run() {
                if (!initializationFinish) {
                    ...
                    AdvertData advert = new AdvertData(BitmapFactory.decodeResource(SupplierApp.getInstance().getResources(), R.mipmap.advert1), System.currentTimeMillis());
                    advertData.add(advert);
                    AdvertData advert1 = new AdvertData(BitmapFactory.decodeResource(SupplierApp.getInstance().getResources(), R.mipmap.advert2), System.currentTimeMillis());
                    advertData.add(advert1);
                    AdvertData advert2 = new AdvertData(BitmapFactory.decodeResource(SupplierApp.getInstance().getResources(), R.mipmap.advert3), System.currentTimeMillis());
