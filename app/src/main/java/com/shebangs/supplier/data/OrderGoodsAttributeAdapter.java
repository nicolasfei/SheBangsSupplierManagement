...
public class OrderGoodsAttributeAdapter extends BaseAdapter {

    private Context context;
    private List<OrderGoodsAttribute> attributes;

    public OrderGoodsAttributeAdapter(Context context, List<OrderGoodsAttribute> attributes) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        OrderGoodsAttribute attribute = attributes.get(position);
        ...
        String num = String.valueOf(attribute.num);
